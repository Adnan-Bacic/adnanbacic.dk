...
<body>
	...
	<section class="container">
		...
		<section class="container">
			<div class="row">
				<div class="col-12">
					<h2 class="text-center" data-aos="fade-up">Skills</h2>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="media mb-5 mx-auto" data-aos="fade-up">
			...
			<div class="row">
				<div class="col-12">
					<div class="media mb-5 mx-auto" data-aos="fade-up">
						<i class="fab fa-react customFA align-self-start" title="React"></i>
						<div class="media-body ml-3">
							...
							<div class="media mt-3" data-aos="fade-up">
							<!--no expo cli icon, so using an alternative icon-->
								<i class="fas fa-terminal mr-4 customFAsmaller" title="Expo"></i>
									<div class="media-body">
										<h3 class="mt-0">Expo CLI</h3>
										<p>Expo CLI is an alternative to the React Native CLI for creating and developing React Native apps.
										<br>
										I have experience working the Expo CLi for creating React Native apps.</p>
									</div>
							</div>
						</div>
					</div>
					...
					<div class="media mb-5 mx-auto" data-aos="fade-up">
						<a href="wordpress.php"><i class="fab fa-wordpress customFA align-self-start" title="Wordpress"></i></a>
							<div class="media-body ml-3">
								...
								<div class="media mt-3" data-aos="fade-up">
								<i class="fab fa-yoast mr-4 customFAsmaller" title="Yoast SEO"></i>
									<div class="media-body">
										<h3 class="mt-0">Yoast SEO</h3>
										<p>Yoast SEO is one of the most popular plugins for adding SEO to websites.
										<br>
										I have experience working with Yoast to optimize SEO.</p>
									</div>
							</div>
							<div class="media mt-3" data-aos="fade-up">
			...
			<h2 class="mb-5" data-aos="fade-up">Other</h2>

			<div class="row">
				<div class="col-12">
					<div class="media mb-5 mx-auto" data-aos="fade-up">
						<i class="fab fa-git-alt customFA align-self-start" title="Git"></i>
						<div class="media-body ml-3">
							<h2 class="mt-0">Git</h2>
							<p>Git is a version control system widely used for development</p>
							<p class="mb-0">I have experience using Git for version control of my development.</p>
							<div class="media mt-3" data-aos="fade-up">
							<i class="fab fa-github mr-5 customFAsmaller" title="Github"></i>
									<div class="media-body">
										<h3 class="mt-0">Github</h3>
										<p>Github is an online code sharing platform which utalizes Git.
										<br>
										I have experience using Github in combination with Git to create branches, pull requests etc.</p>
									</div>
							</div>
						</div>
					</div>
