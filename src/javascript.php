			...
			<div class="row">
				<div class="col-lg-4">
					<a href="https://adnanbacic.dk/folders/javascript/es6-crypto-api/" target="_blank" rel="noopener noreferrer">
						<img src="images/project-thumbnails/crypto-api-thumbnail.png" class="img-fluid border" alt="JS Crypto API">
					</a>
				</div>
				<div class="col-lg-8">
						<h5>Crypto API</h5>
			...
			<div class="row">
				...
				<div class="col-lg-4">
					<a href="https://adnanbacic.dk/folders/javascript/shopping-list/" target="_blank" rel="noopener noreferrer">
						<img src="images/project-thumbnails/shopping-list-thumbnail.png" class="img-fluid border" alt="shopping list">
					</a>
				</div>
			</div>
